...
switch ($CorSala) {
    case "Artes": $Style = "background-color:rgb(242,128,0);color:rgb(255,255,255);";
        break;
    case "Geografia": $Style = "background-color:rgb(68,157,9);color:rgb(255,255,255);";
        break;
    case "História": $Style = "background-color:rgb(22,143,77);color:rgb(255,255,255);";
        break;
    case "Filosofia": $Style = "background-color:rgb(105,14,28);color:rgb(255,255,255);";
        break;
    case "Matemática": $Style = "background-color:rgb(21,104,145);color:rgb(255,255,255);";
        break;
    case "Sociologia": $Style = "background-color:rgb(22,16,106);color:rgb(255,255,255);";
        break;
    case "Biologia": $Style = "background-color:rgb(104,15,104);color:rgb(255,255,255);";
        break;
    case "Física": $Style = "background-color:rgb(170,174,0);color:rgb(255,255,255);";
        break;
    case "Inglês": $Style = "background-color:rgb(0,170,106);color:rgb(255,255,255);";
        break;
    case "Português": $Style = "background-color:rgb(146,24,28);color:rgb(255,255,255);";
        break;
}
